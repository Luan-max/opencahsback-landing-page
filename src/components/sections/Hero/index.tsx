    ...
    >
      <div className="flex flex-col sm:py-0">
        <div className="max-w-2xl">
          ...
          <p className="py-3 md:text-base text-sm leading-[1,3125rem] font-medium text-white lg:text-[1.25rem] xl:text-[1.25rem] xl:leading-[1.875rem] lg:leading-[1.875rem] opacity-70">
